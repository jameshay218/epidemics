...
public:
  ...
  // Parameter and Epidemic handling funtions
  ...
  vector<double> convert_parameters_back(vector<double> pars, int number, double detection, double lowerTime, double upperTime);
  vector<double> convert_parameters_forward(vector<double> pars, int number, double time,double lowerTime, double upperTime);
